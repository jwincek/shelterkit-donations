...
echo esc_html__( 'REASON:', 'shelter-donations' ) . "\n";
...
echo esc_html__( 'To update your logo, please ensure it meets the following requirements:', 'shelter-donations' ) . "\n";
echo "- " . esc_html__( 'High resolution (minimum 300x300 pixels)', 'shelter-donations' ) . "\n";
echo "- " . esc_html__( 'PNG or JPG format with transparent or white background preferred', 'shelter-donations' ) . "\n";
echo "- " . esc_html__( 'Clear, legible design without offensive content', 'shelter-donations' ) . "\n";
echo "- " . esc_html__( 'You must have rights to use the logo', 'shelter-donations' ) . "\n\n";

echo esc_html__( 'You can upload a new logo through your My Account page, or reply to this email with an updated version attached.', 'shelter-donations' ) . "\n\n";

echo esc_html__( 'If you have any questions or need assistance, please don\'t hesitate to contact us.', 'shelter-donations' ) . "\n\n";

echo esc_html__( 'Best regards,', 'shelter-donations' ) . "\n";
