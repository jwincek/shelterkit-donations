...
<h2><?php esc_html_e( 'Membership Details', 'shelterkit-donations' ); ?></h2>
...
<table class="td" cellspacing="0" cellpadding="6" border="1" style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    <tbody>
        ...
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Type', 'shelterkit-donations' ); ?></th>
        ...
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Business Name', 'shelterkit-donations' ); ?></th>
            <td style="padding: 12px;"><?php echo esc_html( $membership['business_name'] ); ?></td>
        </tr>
        <?php endif; ?>
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Start Date', 'shelterkit-donations' ); ?></th>
        ...
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Member ID', 'shelterkit-donations' ); ?></th>
...
<h2><?php esc_html_e( 'Your Member Benefits', 'shelterkit-donations' ); ?></h2>
...
<p style="background-color: #e7f3fe; padding: 15px; border-left: 4px solid #2196F3;">
    ...
    printf(
        ...
        esc_html__( 'Visit your %s to view your membership status, giving history, and more.', 'shelterkit-donations' ),
        '<a href="' . esc_url( wc_get_account_endpoint_url( 'donor-dashboard' ) ) . '">' . esc_html__( 'Donor Dashboard', 'shelterkit-donations' ) . '</a>'
    );
    ?>
</p>

<p>
    <?php esc_html_e( 'Thank you for supporting our mission to help animals in need!', 'shelterkit-donations' ); ?>
</p>
