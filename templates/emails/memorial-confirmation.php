...
<p>
    ...
    printf(
        ...
        esc_html__( 'Thank you for your heartfelt memorial tribute in honor of %s. Your donation helps us continue our mission while honoring the memory of your loved one.', 'shelterkit-donations' ),
        '<strong>' . esc_html( $memorial['honoree_name'] ?? '' ) . '</strong>'
    );
    ?>
</p>

<h2><?php esc_html_e( 'Memorial Details', 'shelterkit-donations' ); ?></h2>

<table class="td" cellspacing="0" cellpadding="6" border="1" style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    <tbody>
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'In Memory Of', 'shelterkit-donations' ); ?></th>
            <td style="padding: 12px;"><strong><?php echo esc_html( $memorial['honoree_name'] ?? '' ); ?></strong></td>
        </tr>
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Memorial Type', 'shelterkit-donations' ); ?></th>
        ...
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Species', 'shelterkit-donations' ); ?></th>
            <td style="padding: 12px;"><?php echo esc_html( Helpers\get_species_label( $memorial['pet_species'] ) ); ?></td>
        </tr>
        <?php endif; ?>
        <tr>
            <th scope="row" style="text-align: left; padding: 12px; background-color: #f8f8f8;"><?php esc_html_e( 'Donation Amount', 'shelterkit-donations' ); ?></th>
...
<h3><?php esc_html_e( 'Your Tribute Message', 'shelterkit-donations' ); ?></h3>
...
<p style="background-color: #e7f3fe; padding: 15px; border-left: 4px solid #2196F3;">
    <?php esc_html_e( 'View and share your memorial page:', 'shelterkit-donations' ); ?><br>
...
<p style="background-color: #d4edda; padding: 15px; border-left: 4px solid #28a745;">
    <?php esc_html_e( 'We will notify the family of your thoughtful tribute as you requested.', 'shelterkit-donations' ); ?>
</p>
<?php endif; ?>

<p>
    <?php esc_html_e( 'This donation is tax-deductible. Please keep this email as your receipt for tax purposes.', 'shelterkit-donations' ); ?>
</p>

<p>
    <?php esc_html_e( 'With deepest gratitude,', 'shelterkit-donations' ); ?><br>
