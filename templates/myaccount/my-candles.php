...
<div class="sd-my-candles">
    ...
    <div class="sd-candles-empty">
        <p><?php esc_html_e( 'You haven\'t lit any candles yet.', 'shelterkit-donations' ); ?></p>
        <p><?php esc_html_e( 'Light a candle on a memorial to remember a beloved companion.', 'shelterkit-donations' ); ?></p>
    </div>
    <?php else : ?>
    <ul class="sd-candles-list">
        ...
        <li class="sd-candle-row">
            ...
            <span class="sd-candle-count">
                <?php
                printf(
                    esc_html( /* translators: %d: number of candles lit */ _n( '%d candle lit', '%d candles lit', $count, 'shelterkit-donations' ) ),
                    (int) $count
                );
                ?>
            </span>
